...
size_t computeEWACalib( size_t tp1,double dbesteta,
  ...
  if (loss_gradient){
    if (cs=="square" ) return ewaCalib<SquL,true>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="absolute") return ewaCalib<AbsL,true>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="percentage") return ewaCalib<PerL,true>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="log") return ewaCalib<LogL,true>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="pinball") return ewaCalib<PinL,true>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
  }
  else{
    if (cs=="square" ) return ewaCalib<SquL,false>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="absolute") return ewaCalib<AbsL,false>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="percentage") return ewaCalib<PerL,false>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="log") return ewaCalib<LogL,false>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
    if (cs=="pinball") return ewaCalib<PinL,false>(tp1,dbesteta,awake,experts,weights,weta,w0,grideta,y,eta,cumulativeloss,prediction,loss_tau);
  }
